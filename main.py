...
os.environ["GROQ_API_KEY"] = "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"
...
def initialize():
    ...
    chat_llm = models.get_ollama(model_name="mistral-nemo:12b-instruct-2407-q8_0")
    ...
    utility_llm = models.get_ollama(model_name="mistral-nemo:12b-instruct-2407-q8_0")

    # embedding model used for memory
    # embedding_llm = models.get_embedding_openai()
    embedding_llm = models.get_embedding_hf()
    # embedding_llm = Memory()
    ...
    config = AgentConfig(
        ...
        # memory=memory,  # Add memory to the agent configuration
        # memory_subdir = "",
        auto_memory_count=0,
        # auto_memory_skip = 2,
